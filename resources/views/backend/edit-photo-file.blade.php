    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <strong>Photo File - Edit Form</strong>
            </div>
            <div class="card-body card-block">
                <form action="{{route('admin.photo-file.update', $data->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="phototitle" name="photoTitle" value="{{$data->title}}" placeholder="Enter the photo title"
                                class="form-control">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea name="photofilelink" id="photofilelink" rows="20"
                                placeholder="Please use ',' comma after every photo file link if there are multiple links." class="form-control">{{$data->file_link}}</textarea>
