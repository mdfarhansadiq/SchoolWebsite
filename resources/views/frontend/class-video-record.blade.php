...
<body>
    ...
    <section class="section_gap_top">
        <div class="container" style="padding: 100px 20px;">
            <h1 class="text-center" style="font-size: 2.5rem; font-weight: bold; color: #2c3e50; margin-bottom: 50px;">
                Find the Class Video Recording
            </h1>

            <div class="card"
                style="border: none; background-color: #f9fafc; border-radius: 12px; box-shadow: 0 0 15px rgba(0, 0, 0, 0.1); padding: 40px;">
                <div class="card-body">
                    <form action="{{ route('class-record.result') }}" method="get" enctype="multipart/form-data"
                        ...
                        <div class="form-footer text-center">
                            <button type="submit" class="btn btn-primary"
                                style="padding: 12px 40px; border-radius: 30px; font-size: 1.2rem;">
                                Find
                            </button>
                        </div>
                    </form>
