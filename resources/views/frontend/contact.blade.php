        ...
        <div class="container"
            ...
            <form action="{{ route('contact.create') }}" method="POST">
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                    ...
                    <textarea id="message" name="message" class="form-control" rows="7" placeholder="Your message" required
                        style="width: 100%; padding: 15px; border-radius: 8px; border: 1px solid #ddd;"></textarea>
                </div>
                ...
                <div style="text-align: center;">
                    <button type="submit" class="btn"
                        style="padding: 15px 30px; background-color: #007bff; color: #fff; border: none; border-radius: 8px; font-size: 16px; cursor: pointer;">Send
                        Message</button>
                </div>
            </form>
        </div>
